...
public class DesUtil {
    ...
    /** 字符串默认键值 */
    private static String strDefaultKey = "kedou";
    /** 加密工具 */
    ...
    public static void main(String[] args) {
        try {
            ...
            String test21 = "base1";
            DesUtil des21 = new DesUtil("www.datanew.com");// 自定义密钥
            System.out.println("加密前的字符：" + test21);
            System.out.println("加密后的字符：" + des2.encrypt(test21));
            System.out.println("解密后的字符：" + des2.decrypt(des2.encrypt(test21)));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
