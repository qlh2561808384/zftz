...
@Entity
@Table(name = "ZFTZ_XMGCJSBA")
public class ZftzXmgcjsba {
    ...
    @SequenceGenerator(name = "sequence", sequenceName = "seq_zftz_xmgcjsba")
    @Basic
    @Column(name = "ID")
    public Long getId() {
