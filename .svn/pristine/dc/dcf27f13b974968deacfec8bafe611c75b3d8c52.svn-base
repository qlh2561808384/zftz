...
<head>
    ...
    <script>
        ...
        var zgbm = [];
        var jldw = [];
        // var ZT = [{id:1,text:"审核项目"},{id:0,text:"已审核完成"},{id:2,text:"经办项目"}];
        var ZT = [{id:1,text:"审核项目"},{id:2,text:"经办项目"}];
        $(function(){
            $.dajax({
                            ...
                            "plug": [
                                {
                                    "plug": [
                                        {
                                            "dtype":"html",
                                            "dragHtml":"<h4 class='text-center'><b>项目概算意见反馈</b></h4>"
                                        },
                                        {
                                            "dtype": "dtable",
                                            "id":"tab",
                                            ...
                                            "columns": [
                                                ...
                                                // {field:"XMYJZXID", title:"项目概算意见征询唯一标示id", width:100, align:"center", visible: false},
                                                ...
                                                {field:"LCHJ", title:"状态", width:100, align:"center",formatter:treeFormatterZT}
                                            ],
                                            searchbar: {
                                            ...
                                            "toolbar": [
                                                ...
                                                {"name":"审核", "classes":"btn bootstrap-table-submit", "id":"SH","type":"button", "onclick":"submit()"},
                                                {"name":"退回", "classes":"bootstrap-table-disable","id":"TH", "type":"button", "onclick":"back()"}
                                            ],
                                            "clickToSelect": true
                                        }
                                    ],
                                ...
                                "plug":[
                                    {
                                        ...
                                        "dragHtml":'<ul class="nav nav-tabs" role="tablist">' +
                                            '    <li role="presentation" class="active"><a href="#infoTab1" aria-controls="infoTab1" role="tab" data-toggle="tab">项目概算征询单</a></li>' +
                                        ...
                                        "plug":[
                                            {
                                                ...
                                                "plug":[
                                                    {
                                                        "dtype": "html",
                                                        "dragHtml": "<h4 class='text-center'><b>项目概算征询单</b></h4>"
                                                    },
                                                    {
                                                        "dtype":"html",
                                                        "dragHtml":'<div class="toolbar layout_toolbar clearfix">' +
                                                            '<button class="bootstrap-table-save" type="button" id="savebtn" onclick="save()">保存</button>' +
                                                            '<button class="bootstrap-table-submit" type="button" id="submitInsideBth" onclick="submitInside()">审核</button>' +
                                                            '<button class="bootstrap-table-clear" type="button" id="ZBKBtn" onclick="openZBK()">标准库</button>' +
                                                            '</div>'
                                                    },
                                                    {
                                                        "dtype":"dform",
                                                        ...
                                                        "inputs":[
                                                            ...
                                                            {title: "项目规划选址", name:"XMGHXZ", type:"textBox",colspan:2,disabled:"true",setReadonly:true},
                                                            {
                                                                ...
                                                                type: "textBox",
                                                                multiline: true,
                                                                colspan: 2, disabled: "true", setReadonly: true
                                                            },
                                                            {title: "<br/>反馈意见", name:"FKYJ", id:"fkyj",type:"textBox", multiline:true, colspan:2},
                                                        ]
                                                    },
                                                    {
                                                        "dtype":"html",
                                                        "dragHtml":"<h5 class='text-center'><b><span style='text-align: left'>过程意见:</span></b></h5>"
                                                    },
                                                    {
                                                        "dtype": "dtable",
                                                        "id":"gcyj",
                                                        ...
                                                        "columns": [
                                                            ...
                                                            {field:"XM", title:"反馈人", width:100, align:"center"},
                                                            {field:"DDRQ", title:"到达时间", width:100, align:"center",formatter:changeDateFormat},
                                                            {field:"CLSJ", title:"反馈时间", width:100, align:"center",formatter:changeDateFormat},
                                                            {field:"CLYJ", title:"反馈意见", width:100, align:"center"},
                                                        ],
                                                        // "url": "pro/getShyj.do"
                                                    },
                                                   /* {
                                                        "dtype":"html",
                                                        "dragHtml":'<div style="padding:20px 0 10px 15px;"><b>附件列表：</b><button type="button" class="bootstrap-table-upload" onclick="uploadFile(2,\'#xmgszxd \')">上传附件</button></div>'
                                                    },*/
                                                    {
                                                        "dtype":"div",
                                                        "classes":"clearfix",
                                                ...
                                                "plug":[
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "inputs":[
                                                            ...
                                                            {title: "投资限额", name:"TZXE", type:"decimal",disabled:"true",setReadonly:true,textAlign:"right",textAlign:"right"},
        ...
        function editRow() {
            ...
            $.dajax({
                url: "pro/shjl/" + type + ".do",
                data: {
                    ywId: dataArr[0].XMGSYJID
                },
                cache: true,
                type: "POST",
                dataType: "json",
            ...
            fkyj = dataArr[0].FKYJ;
            // $("#gcyj").dtable("refresh",{query: {id: xmid}});

            // $("#xmmc").searchTree("reload",{url: "pro/getXmmcTree.do?id=0"});
            $("#table").dform("load", dataArr[0]);
            $("#XMMC").textBox("disable");
            if (dataArr[0].LCHJ == 0) {
                $("#fkyj").textBox("disable");
                $("#savebtn").attr('disabled',true);
                $("#submitInsideBth").attr('disabled',true);
                $("#ZBKBtn").attr('disabled',true);
            }
        }
...
//                 xmid: xmId
        ...
        function submit() {
            ...
            var xmgsfkyj = new Array();
            var type = 2;
            for(var i = 0;i<dataArr.length;i++){
                data[i] = dataArr[i].YJID;
                DqLchjs[i] = dataArr[i].LCHJ + "";
                xmgsfkyj[i] = dataArr[i].FKYJ;
                if (DqLchjs[i] == 0) {
        ...
        function submitInside() {
            ...
            var lchj = [dataArr[0].LCHJ + ""];
            var comm = [dataArr[0].FKYJ];
            if (lchj == 0) {
                $.dalert({text:"该流程已经结束", icon: 2})
            }else {
                save1();
                $.dajax({
                    url: "pro/next/" + type + ".do",
        ...
        function back(){
            ...
            if (lch == 0) {
                return $.dalert({text:"流程已结束不能退回", icon: 2});
            } else {
                setThYj();
            }
        }
